            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-primary">Pengaduan Masyarakat</h1>
                        <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" data-toggle="modal" data-target="#addDoctor"><i class="fas fa-download fa-sm text-white-50"></i> Download</a>
                    </div>
                </div>
                <!-- /.container-fluid -->
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        @forelse ($kendalas as $ken)
                                        <tr>
                                            <td> {{$loop->iteration}} </td>
                                            <td> {{$ken->name}} </td>
                                            <td> {{$ken->complain}} </td>
                                            <td> {{$ken->phone}} </td>
                                            <td> {{$ken->created_at->isoFormat('dddd, D MMMM Y')}} </td>
                                            <td>
                                                <button class="btn btn-danger btn-sm" title="hapus" data-toggle="modal" onclick="deleteMessage({{$ken->id}})"><i class="fas fa-trash"></i></button>       
                                        </tr>
                                        @empty
